...
printFullName(firstName: "Dalton", lastName: "Turner")


func printFullName(_ firstName : String, _ lastName : String) {
    print(firstName + " " + lastName)
}
printFullName("Dalton", "Turner")


func calculateFullName(_ firstName : String, _ lastName : String) -> String {
    return firstName + " " + lastName
}
let myName = calculateFullName("Dalton", "Turner")


func calculateFullNameLen(_ firstName : String, _ lastName : String) -> (name: String, length: Int) {
    let fullName = firstName + " " + lastName
    return (fullName, fullName.count)
}
let myName1 = calculateFullNameLen("Dalton", "Turner")
let name = myName1.name
let lengthOfName = myName1.length
...
// The difference between the stride function overloads is the parameter naming and index closed or half closed.
